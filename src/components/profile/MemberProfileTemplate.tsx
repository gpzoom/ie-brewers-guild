...
export function MemberProfileTemplate({ data, search }: MemberProfileTemplateProps) {
  const { member, hours, specialHours, events, carouselSlides, links, categories, crossLink, headerPrev, headerNext, locationCities, logoPublicUrl, coverAsset } = data;
  ...
  return (
    <article className="mx-auto max-w-[1120px]">
      ...
      <div className="bg-canvas md:overflow-hidden md:rounded-card">
        <ProfileHero member={member} coverUrl={coverUrl} logoUrl={logoPublicUrl} locationCities={locationCities} />
