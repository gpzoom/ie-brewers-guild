...
export function Header() {
  ...
  return (
    <header className="theme-site sticky top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
